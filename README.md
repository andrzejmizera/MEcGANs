...
The datasets described in the manuscript, i.e., the edge-intensive, large, and small datasets, are made available via Mendeley Data and can be accessed [here](https://data.mendeley.com/datasets/jk3wr7crj7/3).
