...
3. Edit the settings in the MEcGANs/config/config_nirrgb2rgbcloud.yml file or replace it with a config_nirrgb2rgbcloud.yml file provided for the three datasets in the respective subfolders of 'Config_files/MEcGANs'.
