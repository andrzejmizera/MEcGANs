...
For example, to load the model of MEcGANs trained with the edge-intensive dataset with NIR cloud penetrability set to 1%, please use the following command from the MEcGANs folder:
